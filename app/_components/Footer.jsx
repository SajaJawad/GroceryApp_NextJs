...
const Footer = () => {
  ...
  <div className="mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
    <div className="text-center flex flex-col items-center justify-center  ">
      ...
      <Button href="#" className="mt-8 inline-flex items-center justify-center rounded-full border border-indigo-600 px-12 py-3 text-sm font-medium text-white hover:bg-[#e6b800] hover:text-white">
        Get Started
      </Button>
    </div>
