        ...
        <div className='mt-5'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 justify-items-center items-center mt-5'>
                {categoryList?.map((category, index) => (
                    <div className='w-30 h-35 mt-3 bg-amber-100 p-3 flex flex-col items-center text-center group ' key={index}>
                        <Image
                            ...
                            />
                                    <p className='text-amber-500 font-bold capitalize'> {category.name}</p>
